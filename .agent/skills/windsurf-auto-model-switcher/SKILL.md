...
description: Switch AI models programmatically. Apply when needing to change models from workflows or scripts.
---

# Auto Model Switcher

Switch AI models programmatically using keyboard simulation.

## MUST-NOT-FORGET

- Requires custom keybindings (see SETUP.md)
- German keyboards: Use F-keys, not Ctrl+Alt (AltGr conflict)
- Model selector requires IDE window focus
...
**Script types into editor**: Run SETUP.md and restart the IDE.

**Model doesn't change**: Ensure model selector panel is visible.
