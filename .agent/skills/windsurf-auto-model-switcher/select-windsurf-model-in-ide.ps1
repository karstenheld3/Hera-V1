# Auto Model Switcher - Select specific model by query
...
# Hardcoded safe fallback models (always available in the IDE)
...
if (-not $proc) {
    Write-Error "No IDE window found matching: $WindowTitle"
    exit 1
}
