...
if ($removedCount -gt 0) {
    ...
    Write-Host "Restart the IDE to apply changes."
} else {
...
Note: This only removes the custom keybindings. The default IDE keybindings (`Ctrl+/` and `Ctrl+Shift+/`) remain unaffected.
